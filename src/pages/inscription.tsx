...
<div className="bg-white max-w-4xl flex items-center mx-auto md:min-h-screen p-4">
      <div className="grid md:grid-cols-3 items-center [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] rounded-xl overflow-hidden">
        ...
        <form className="md:col-span-2 w-full py-6 px-6 sm:px-14 max-w-lg mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative flex items-center">
                <input name="name" type="text" required className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter votre nom" />
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input name="email" type="email" required className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter votre email" />
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input name="password" type="password" required className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter votre mot de passe" />
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="remember-me" className="ml-3 block text-sm text-slate-600">
                J'accepte les <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1">Termes et Conditions</a>
              </label>
            </div>
          </div>
          ...
          <p className="text-slate-600 text-sm mt-6 text-center">Vous avez déjà un compte? <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1">Connexion</a></p>
        </form>
      </div>
    </div>
  )
